...
| AC-12 gate, both branches | wrongly-answered **1 (held)** · recall **0.625** · retained **43** — SHIPPABLE. ⚠️ Superseded 2026-09-16: that gate measured `search_hybrid` alone. Through the production path the same run reads recall **0.797**, retained **54**. Superseded again by the comparison-screen fix: recall **0.891–0.906** over two runs, retained **61**, wrongly-answered **1**, user-visible wrong **0** |
