...
| | |
|---|---|
| **Last worked** | 1 September 2026 (Google sign-in — "Continue with Google" now works end to end, and needs one thing from you: the client secret) · *(earlier:)* 31 August 2026 (night — the AB-7 build you approved: auto-suggested document type, Key Obligations, the 3-column workspace with the always-visible Ask bar) |
...
| **Health** | 1,050 backend + 129 frontend checks passing, none failing (1 skipped); 15 visual baselines reproducing; CI (15 jobs) green on every push. *(Counts re-measured 1 Sep, late, by running both suites.)* |
