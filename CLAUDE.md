...
| Requirement catalogue: **SUPERSEDED 2026-08-19** — the owner instructed full-document review; **37 active ratified Company Standards** (MSA · TOS · NDA · SLA, plus the four **Partner Agreement** positions ratified from Constitution §31 by `AM-72`, AB-24) — 44 files counting the seven `AM-65` retired | [docs/00-project/CLAUSE_CATALOGUE.md](docs/00-project/CLAUSE_CATALOGUE.md) + `backend/config/company_standards/` |
